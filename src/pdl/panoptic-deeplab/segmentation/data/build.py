# ------------------------------------------------------------------------------
# Provides functions to build dataloader for training and testing
...
def build_train_loader_from_cfg(config):
    """Builds dataloader from the supplied configuration file.
    Args:
        config: the configuration file.
    ...
    print("[build.py]: number of workers" + str(num_workers))
    print("[build.py]: images per batch" + str(images_per_batch))
    print("[build.py]: Dataset length" + str(len(dataset)))
