...
# For resnet 34 backbone variant
...
_C.TRAIN.REFINE = False     # Added a new parameter to deal with refining an already trained model with fresh learning rate schedule
# -----------------------------------------------------------------------------
# DATALOADER
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
_C.DATALOADER.NUM_WORKERS = 1   #Changed it from 4 to 1
