# -*- coding: utf-8 -*-
"""day_night_conversion_training_2_4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lrQqopFUc2sK40BjODDlErjs3LyKbADi

# File used for REFINING of day-to-night downloaded pre-trained model on Nighttime driving dataset,  and test it to generate translated images 
# Approach 2 - Solution 4
...
os.chdir('datasets/cityscapes_refine_pretrained_sol_4')

# Helper commands for datasetup (not always needed)
#!unzip train_original.zip

# helper commands for data setup (not always needed)
#!ls -dq *frame* | wc -l

# Refine the downloaded pretrained model on cityscapes to nighttime driving dataset conversion
!python train.py --dataroot ./datasets/cityscapes_refine_pretrained_sol_4/ --name cityscapes_refine_pretrained_sol_4 --model cycle_gan --preprocess crop --crop_size 256 --continue_train --epoch_count 162

# Used to convert day images to poor light/ night images
!python test.py --dataroot ./datasets/cityscapes_refine_pretrained_sol_4/testA --name cityscapes_refine_pretrained_sol_4 --model test --no_dropout --num_test=900 --preprocess none #--use_wandb
