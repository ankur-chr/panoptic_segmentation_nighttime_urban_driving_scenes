# -*- coding: utf-8 -*-
"""day_night_conversion_training_2_5.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1F_VsT_Uli_YjKnPC9hMYfhsHSanCoeSQ

# File used for REFINING Solution 3 model using twilight and dark images of Dark Zurich dataset 
# Approach 2 - Solution 5
...
#os.chdir('datasets/cityscapes_sol_5')
...
!python train.py --dataroot ./datasets/cityscapes_sol_5/ --name cityscapes_sol_5 --model cycle_gan --preprocess crop --crop_size 256 --continue_train #--epoch_count 162

# Used to convert day images to poor light/ night images
!python test.py --dataroot ./datasets/cityscapes_sol_5/testA --name cityscapes_sol_5 --model test --no_dropout --num_test=900 --preprocess none #--use_wandb
