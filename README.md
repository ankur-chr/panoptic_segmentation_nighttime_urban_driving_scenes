...
This repository contains the source code and related files for the research project titled above, and linked here (https://arxiv.org/abs/2306.13725 Ref: arXiv:2306.13725 [cs.CV] ). The research is based on existing deep-learning architectures and utilizes the Domain Adaptation technique to improve panoptic segmentation for nighttime or low-illumination urban driving scenes by making use of various existing nighttime driving datasets.
